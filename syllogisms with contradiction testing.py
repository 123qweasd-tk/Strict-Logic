...
print("S ",solution," P")
print('------------------------------------------------------------')
print('1. premis: ',first_formula[0],'-',first_formula[0],' ',first_formula[1],'-',first_formula[1],' ',first_formula[2],'-',first_formula[2],' ',first_formula[3],'-',first_formula[3])
print('2. premis: ',second_formula[0],' ',second_formula[1],' ',second_formula[2],' ',second_formula[3],',',second_formula[0],' ',second_formula[1],' ',second_formula[2],' ',second_formula[3])
print('------------------------------------------------------------')
print('conclusion:',solution[0],' ',solution[1],' ',solution[0],' ',solution[1],' ',solution[2],' ',solution[3],' ',solution[2],' ',solution[3])
print(' ')
